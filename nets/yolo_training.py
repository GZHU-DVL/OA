...
class YOLOLoss(nn.Module):
    ...
    def forward(self, input, targets=None):
        ...
        ##################
        #先验框标签平滑
        #mask_L, noobj_mask_L, t_box_L, tconf_L, tcls_L, box_loss_scale_x_L, box_loss_scale_y_L = self.get_target(targets_L, scaled_anchors,in_w, in_h,self.ignore_threshold)     
        #mask_S, noobj_mask_S, t_box_S, tconf_S, tcls_S, box_loss_scale_x_S, box_loss_scale_y_S = self.get_target(targets_S, scaled_anchors,in_w, in_h,self.ignore_threshold)
        ##################  
        #---------------------------------------------------------------#
        ...
        ##################
        #先验框标签平滑
        #noobj_mask_L, pred_boxes_for_ciou_L = self.get_ignore(prediction, targets_L, scaled_anchors, in_w, in_h, noobj_mask_L)
        #noobj_mask_S, pred_boxes_for_ciou_S = self.get_ignore(prediction, targets_S, scaled_anchors, in_w, in_h, noobj_mask_S)
        ##################  
        if self.cuda:
